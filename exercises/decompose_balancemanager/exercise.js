...
exercise = runTests(exercise, function(changeHandler, test) {
    test('should have a function called increaseBalance()', function() {
        expect(typeof changeHandler.increaseBalance).to.equal('function');
    });
    ...
    test('should not have a function called getProducts()', function() {
        expect(typeof changeHandler.getProducts).to.not.equal('function');
    });
